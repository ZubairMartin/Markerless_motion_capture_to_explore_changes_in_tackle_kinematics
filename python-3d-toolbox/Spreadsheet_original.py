...
def main(location='~/Desktop/',folder='~/Desktop/',name='Spreadsheet', bag_mass = 40,tackler_mass=1,Start_frame_est=0,End_frame_est=0,Start_frame=0,End_frame=0,temp='notsure',player_number = 'P'):
    ...
    def main2():
        ...
        # Tackle Number
        worksheet.write(1, 3, temp[temp.find('e')+1:temp.find('_')] )
